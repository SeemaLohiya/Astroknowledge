 ...
 *
 * GoDaddy DNS (manual ΓÇö required once):
 ...
 *   4. Add A record:  Host @   ΓåÆ  216.24.57.1   TTL 600
 *   5. Add CNAME:     Host www ΓåÆ  astroknowledge.onrender.com   TTL 600
...
async function main() {
  ...
  console.log("\nAfter DNS propagates (5ΓÇô60 min), verify at:");
