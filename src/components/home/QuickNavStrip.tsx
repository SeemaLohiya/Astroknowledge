        ...
        <div className="flex flex-wrap items-center justify-center gap-3 md:gap-4">
          {TABS.map((tab) => (
            <Link
              ...
              href={tab.href}
              className={cn(
                "group relative z-10 flex shrink-0 items-center gap-2.5 rounded-2xl border px-4 py-3 shadow-sm ring-1 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-lg sm:px-5",
                tab.highlight
            ...
            >
              ...
              <span
                className={cn(
                  ...
                  tab.highlight
                    ? "text-gold group-hover:text-gold-bright"
                    : tab.isBook
