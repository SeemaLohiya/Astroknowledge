  ...
  en: [
    {
      ...
      items: [
        ...
        { href: "/dashboard/services?tab=book", label: "Book Consultation", desc: "Schedule a consultation" },
      ],
    },
    {
      label: "Courses",
  ...
  hi: [
    {
      ...
      items: [
        ...
        { href: "/dashboard/services?tab=book", label: "परामर्श बुक करें", desc: "परामर्श का समय निर्धारित करें" },
      ],
    },
    {
      label: "पाठ्यक्रम",
